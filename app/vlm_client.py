...
Важно: если во входящей разметке объект уже помечен как type=table, обязательно верните его с type=table и воспроизведите содержимое в "text" в виде Markdown-таблицы (|...|). Не переклассифицируйте таблицы в text.
